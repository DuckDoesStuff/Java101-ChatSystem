...
public class SignUpUI extends JFrame {
    ...
    public SignUpUI(){
        ...
        formContainer.setBounds(250, 120, 700, 700);
        ...
        userN_jlb.setBounds(40, 10, userN_jlb.getPreferredSize().width, userN_jlb.getPreferredSize().height);
        ...
        firstN_jlb.setBounds(40, 55, firstN_jlb.getPreferredSize().width, firstN_jlb.getPreferredSize().height);
        ...
        lastN_jlb.setBounds(40, 100, lastN_jlb.getPreferredSize().width, lastN_jlb.getPreferredSize().height);
        ...
        address_jlb.setBounds(40, 145, address_jlb.getPreferredSize().width, address_jlb.getPreferredSize().height);
        ...
        dateChooser_jlb.setBounds(40, 190, dateChooser_jlb.getPreferredSize().width, dateChooser_jlb.getPreferredSize().height);
        ...
        gender_jlb.setBounds(40, 235, gender_jlb.getPreferredSize().width, gender_jlb.getPreferredSize().height);
        ...
        pw_jlb.setBounds(40, 325, pw_jlb.getPreferredSize().width, pw_jlb.getPreferredSize().height);
        ...
        login_jlb.setBounds(50, 440, login_jlb.getPreferredSize().width, login_jlb.getPreferredSize().height);
